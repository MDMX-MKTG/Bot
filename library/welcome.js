...
const src = join(__dirname, '..', 'archivos')
...
const render = async ({
    wid = '',
    pp = toBase64(readFileSync(join(src, 'contacto.png')), 'image/png'),
    name = '',
    title = '',
    text = '',
    background = toBase64(readFileSync(join(src, 'Aleatory', 'Aesthetic_000.jpeg')), 'image/jpeg'),
} = {}, format = 'png') => {
